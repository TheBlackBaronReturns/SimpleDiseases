...
public record ViralDiseaseDef(
    ...
    public static final MapCodec<ViralDiseaseDef> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
        ...
        ConditionType.CODEC.fieldOf("organ_group").forGetter(ViralDiseaseDef::organGroup),
        com.mojang.serialization.Codec.STRING.fieldOf("pathogen_type").forGetter(ViralDiseaseDef::pathogenType),
