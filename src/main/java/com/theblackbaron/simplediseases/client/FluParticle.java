...
public class FluParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    protected FluParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        @Nullable
        @Override
        public FluParticle createParticle(SimpleParticleType type, ClientLevel level,
                                          double x, double y, double z,
                                          double xSpeed, double ySpeed, double zSpeed) {
            return new FluParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, this.sprites);
        }
    }
}
