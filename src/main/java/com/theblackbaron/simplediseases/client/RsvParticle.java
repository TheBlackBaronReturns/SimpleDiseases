...
public class RsvParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    protected RsvParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        @Nullable
        @Override
        public RsvParticle createParticle(SimpleParticleType type, ClientLevel level,
                                          double x, double y, double z,
                                          double xSpeed, double ySpeed, double zSpeed) {
            return new RsvParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, this.sprites);
        }
    }
}
