...
public class VomitParticle extends TextureSheetParticle {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        @Nullable
        @Override
        public VomitParticle createParticle(SimpleParticleType type, ClientLevel level,
                                            double x, double y, double z,
                                            double xSpeed, double ySpeed, double zSpeed) {
            return new VomitParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, this.sprites);
        }
    }
}
