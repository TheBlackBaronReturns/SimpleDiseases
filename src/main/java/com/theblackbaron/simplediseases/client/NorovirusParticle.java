...
public class NorovirusParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    protected NorovirusParticle(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        @Nullable
        @Override
        public NorovirusParticle createParticle(SimpleParticleType type, ClientLevel level,
                                                double x, double y, double z,
                                                double xSpeed, double ySpeed, double zSpeed) {
            return new NorovirusParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, this.sprites);
        }
    }
}
